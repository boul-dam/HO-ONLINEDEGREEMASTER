                ...
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
                    <div className="max-w-xl md:mx-auto">
                        <p className="text-white text-3xl font-semibold sm:text-4xl">
                            MBA | BBA - Online Diploma
                        </p>
                        <p className="text-blue-100 mt-3">
                        Hornoverseas in association with AMET UNIVERSITY – India’s Premier Maritime Institution, is revolutionizing education with its flexible online learning programs
                        </p>
                    </div>
                    <div className="mt-4">
