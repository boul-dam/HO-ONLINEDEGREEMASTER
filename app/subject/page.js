        ...
        const features = [
            {
                ...
                title: "MBA",
                desc: "Master of Business Administration (MBA) in Shipping and Logistics Management."
            },
            {
                icon:
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            },
            {
                ...
                title: "B.COM",
                desc: "Bachelor of Commerce (B.Com)."
            },
           {/*} {
                icon:
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="relative max-w-2xl mx-auto sm:text-center">
                        <div className="relative z-10">
                            <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                                Let’s help power your Knowledge
                            </h3>
                            <p className="mt-3">
                            We are happy to inform that the AMET University has become fully eligible to offer the online programmes such as
                            </p>
                        </div>
